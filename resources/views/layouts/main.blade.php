...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
       <div class="container mx-auto flex px-4  flex-col md:flex-row items-center justify-between px-4 py-6">
